...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  #config.ssh.insert_key = false # Use default insecure key
  ...
  config.vm.synced_folder "scripts", "/srv/scripts", group: "www-data", owner: "www-data", mount_options: ['dmode=774','fmode=775']
